...
export const Icons = {
  CrakdLogo: ({ size = 24 }) => (
    <svg width={size} height={size} viewBox="0 0 512 512" fill="none">
      ...
      <rect width="512" height="512" rx="120" fill="url(#crakd_grad)" />
      
      {/* Tassel */}
      <path d="M140 185 L108 235 L108 275 L116 275 L116 235 Z" fill="#ffb300" />
      <circle cx="112" cy="280" r="8" fill="#ffb300" />

      {/* Mortarboard Hat (White) */}
      {/* Skullcap */}
      <path d="M160 220 L160 270 C160 310, 352 310, 352 270 L352 220" fill="#ffffff" />
      {/* Top Diamond */}
      <path d="M256 120 L440 185 L256 250 L72 185 Z" fill="#ffffff" />
      
      {/* Yellow Lightning Bolt overlapping the cap */}
      ...
      <defs>
        <linearGradient id="crakd_grad" x1="0" y1="0" x2="512" y2="512" gradientUnits="userSpaceOnUse">
